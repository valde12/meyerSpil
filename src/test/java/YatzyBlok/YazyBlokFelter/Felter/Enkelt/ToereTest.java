...
class ToereTest {
    ...
    static Toere testYatzyFelt;
    static int[] TRUE_VAERDI_1 = new int[]{1,2,1,2,1,3};
    static int[] TRUE_VAERDI_2 = new int[]{1,2,1,2,1};
    static int[] FALSE_VAERDI_1 = new int[]{1,1,1,1,1,3};
    static int[] FALSE_VAERDI_2 = new int[]{1,1,1,1,1};
    static int RETURN_VAERDI_POINT = 4;

    @BeforeEach
    void constructorTilFelt() {
        testYatzyFelt = new Toere("Navn");
    }

    @Test
    void skalReturn4Point_beregnPoint() {
